...
| 2 | [Publishing and Export Formats](product/EXPORT-FORMATS.md) | Designing static web, open JSON, CSV, Word, PDF, Markdown, image, or asset outputs |
| 3 | [Architecture](architecture/ARCHITECTURE.md) | Designing the project model, runtime, backend, API, or export format |
| 4 | [Implementation Plan](developer/IMPLEMENTATION-PLAN.md) | Starting development, selecting a module, or creating a milestone issue |
| 5 | [Self-Hosting Guide](operations/SELF-HOSTING.md) | Designing deployment, data protection, administration, or operations |
| 6 | [User Documentation Plan](product/USER-DOCUMENTATION-PLAN.md) | Writing tutorials, reference pages, onboarding, or release documentation |
| 7 | [Roadmap](governance/ROADMAP.md) | Understanding phases, dependencies, and the next contribution areas |
